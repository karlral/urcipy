...
public class Corredor  implements java.io.Serializable {
    ...
    public Corredor(Categoria categoria, Ciudad ciudad, Usuario usuario) {
        this.categoria = categoria;
        this.ciudad = ciudad;
        this.usuario = usuario;
    }

    public Corredor(Integer idcorredor, Categoria categoria, Ciudad ciudad, Usuario usuario, String nombre, String apellido, String ci, Byte sexo, Date fecnac, String telefono, String direccion, String email, Byte verificar, String nacionalidad, String carnet, String carnetatras, String foto, String cidelante, Byte tipocat, String tutorp, String citp, Integer licencia, Boolean modificar, String gruposanguineo, Integer puntua, Date fecmodi, Integer montopuntua, Byte carnetfpc, String observacion, Set<Imc> imcs, Set<Participante> participantes, Set<Miembros> miembroses, Set<CorredorClubRegional> corredorClubRegionals) {
